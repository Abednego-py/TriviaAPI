...
- Sample : `curl -X DELETE http://127.0.0.1:5000/api/questions/27`
...
-Sample : `curl http://127.0.0.1:5000/api/quizzes -X POST -H "Content-Type: application/json" -d '
...
`curl http://127.0.0.1:5000/api/questions -X POST -H 
